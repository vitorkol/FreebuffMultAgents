...
7. **Designer**: cria prototipos com base na especificação da história de usuário `user-stories.md`, fundamentado no design system definidos pelo arquiteto de soluções e líder técnico. e gera o prototype.html `prototype.md`.
8. **QA** executa o plano de testes e grava `test-evidence.md`.
9. Se houver falha, QA atualiza `bugs.md` e o fluxo retorna ao Developer.
10. Se aprovado, QA encaminha as evidências ao ANR para aprovação final.
